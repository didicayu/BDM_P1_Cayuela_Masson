...
\section{Current Implementation Diagram}
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,height=0.75\textheight,keepaspectratio]{../assets/BDM_P1.1.drawio.png}
  \caption{Current implementation architecture for the P1.2 ingestion and landing pipeline.}
\end{figure}
